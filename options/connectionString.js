...
//export const connectionStringUrl = `mongodb://localhost:27017/${process.env.MONGO_DBNAME}?retryWrites=true&w=majority`
...
//export const connectionStringUrlSessions = `mongodb://localhost:27017/${process.env.MONGO_DBNAMESESSIONS}?retryWrites=true&w=majority`
